...
-- Compile using
--
-- ghc -threaded MachRep2DistributedSqlite3.hs
--
-- Edit the cluster.conf file and then fire up some slave nodes:
--
-- ./MachRep2DistributedSqlite3 slave 1 &
-- ./MachRep2DistributedSqlite3 slave 2 &
-- ./MachRep2DistributedSqlite3 slave 3 &
--
-- And start the master node:
--
-- ./MachRep2DistributedSqlite3 master 0
--
